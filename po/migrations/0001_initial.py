    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(blank=True, choices=[('PE', 'PO ENTERED'), ('W', 'WORKING'), ('PC', 'PO CREATED'), ('E', 'EMAILED'), ('C', 'CANCELLED'), ('F', 'FILED'), ('R', 'RECEIVED'), ('PR', 'PARTIAL RECEIVED'), ('MI', 'MISC')], max_length=2, null=True)),
                ('customer_name', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='po.customer')),
            ],
            options={
